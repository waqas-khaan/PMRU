...
@section('title', 'Add Class–Subject | ' . config('app.name'))

@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-ink-900">Add Class–Subject</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-ink-200/80 p-6">
        ...
        <form method="POST" action="{{ route('academics.class-subjects.store') }}" class="space-y-4">
            @csrf
            <div>
