-- ============================================================
-- School System - FINANCE / EXAMS MODULE (complete clean schema)
-- Database: school_finance_exams_db (connection: mysql_finance)
-- Run this when the database already exists (e.g. import into school_finance_exams_db).
-- student_id references students.id in school_students_db.
-- ============================================================
...
-- ------------------------------------------------------------
-- Academic years (for fee/exam context)
-- ------------------------------------------------------------
