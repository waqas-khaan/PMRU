-- ============================================================
-- School System - ACADEMICS MODULE (complete clean schema)
-- Database: school_academics_db (connection: mysql_academics)
-- Run this when the database already exists (e.g. import into school_academics_db).
-- ============================================================
